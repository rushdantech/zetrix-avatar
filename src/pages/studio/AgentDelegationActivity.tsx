...
export default function AgentDelegationActivity() {
  ...
  if (enterpriseAgents.length === 0) {
    return (
      <div className="space-y-4 pb-20 lg:pb-0">
        <h1 className="text-2xl font-bold">Delegation activity</h1>
        <div className="rounded-xl border border-dashed border-border p-8 text-center text-sm text-muted-foreground">
          No agents yet. Create an agent under Agent Studio to see delegation activity here.
        </div>
      </div>
    );
  }
