    ...
    <div className="space-y-10 pb-20 lg:pb-0">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Operational logs and delegation requests for your agents. Choose an agent in each section.
        </p>
      </div>

      {/* 1. Agent operational activity */}
      <section className="space-y-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-lg font-semibold">Activity</h2>
            <p className="text-sm text-muted-foreground">What it did and whether it worked</p>
          </div>
      ...
      {/* 2. Delegation activity per agent */}
      <section className="space-y-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="text-lg font-semibold">Delegation activity</h2>
